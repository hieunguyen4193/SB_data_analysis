---
title: "Monocle3 trajectory analysis, use_partition: `r params$use_partition `"
author:
...
# path.to.s.obj <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20250102/SBharadwaj_20240318_Sample_3_6/data_analysis/07_output/preprocees_sub_clusters/v0.1/v0.1.1/noReIntegration/Project_SBharadwaj_20240318_Sample_3_6_v0.1_v0.1.1.addedInfo.rds"
# path.to.save.output <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20250102/SBharadwaj_20240318_Sample_3_6/data_analysis/04_output/07_output_v0.1.1/seurat_clusters"
...
for (selected.starting.point in list_of_principal_points){
  dir.create(file.path(path.to.save.output, "genes_change_as_functions_of_pseudotime", selected.starting.point), showWarnings = FALSE, recursive = TRUE)
