...
# path.to.s.obj <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20240318/SBharadwaj_20240318_Sample_1_4_7_8_2_5/data_analysis/07_output/v0.1/Monocyte_Macrophages/Project_SBharadwaj_20240318_Sample_1_4_7_8_2_5_v0.1_Monocyte_Macrophages.addedConditions.rds"
# path.to.save.output <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20240318/SBharadwaj_20240318_Sample_1_4_7_8_2_5/data_analysis/04_output/SBharadwaj_20240318_Sample_1_4_7_8_2_5/Monocyte_Macrophages"
...
p1 <- all.nodes %>% ggplot(aes(x = ccaUMAP_1, y = ccaUMAP_2, color = node.degree, label = label)) + geom_point(size = 3) + geom_text_repel(size = 6)
p2 <- all.nodes %>% ggplot(aes(x = ccaUMAP_1, y = ccaUMAP_2, color = node.degree, label = node.name)) + geom_point(size = 3) + geom_text_repel(size = 6)
p1 + p2
```
