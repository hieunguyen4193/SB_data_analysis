...
run_pipeline_for_some_combinations <- function(stage_lst, PROJECT){
  ...
  path.to.output <- file.path(outdir, "SBharadwaj_20250102", PROJECT)
...
input.stage_lst[["Sample_1_4_7_8"]] <- c(
  ctrl_gut_CD45_1 =   "ctrl_gut_CD45_1",
  treated_gut_CD45_1 = "treated_gut_CD45_1",
  treated_gut_CD45_2 = "treated_gut_CD45_2",
  ctrl_gut_CD45_2 =   "ctrl_gut_CD45_2"
...
input.stage_lst[["Sample_3_6"]] <- c(
  ctrl_liver_myeloid =   "ctrl_liver_myeloid",
  treated_liver_myeloid = "treated_liver_myeloid"
)

input.stage_lst[["Sample_1_4_7_8_2_5"]] <- c(
  ctrl_gut_CD45_1 =   "ctrl_gut_CD45_1",
  treated_gut_CD45_1 = "treated_gut_CD45_1",
  treated_gut_CD45_2 = "treated_gut_CD45_2",
  ctrl_gut_CD45_2 =   "ctrl_gut_CD45_2",
...
parser$add_argument("-i", "--input_name", action="store",
                    help="Name of the input combined dataset")
...
for (input.name in names(input.stage_lst)){
  print("----------------------------------------------------------------------")
  print(sprintf("Working on the combined dataset: %s", input.name))
  print("----------------------------------------------------------------------")
  
  PROJECT <- sprintf("SBharadwaj_20240318_%s", input.name)
