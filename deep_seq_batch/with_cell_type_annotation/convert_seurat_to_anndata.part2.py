...
path_to_main_src = "/home/hieunguyen/CRC1382/src_2023/SBharadwaj/deep_seq_batch/with_cell_type_annotation"
samplesheet = pd.read_csv(os.path.join(path_to_main_src, "SampleSheet_for_DGE_CellChat.CellAnnotated.csv"))
