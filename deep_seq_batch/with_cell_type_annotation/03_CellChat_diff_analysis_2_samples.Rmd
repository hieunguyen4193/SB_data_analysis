...
# path.to.s.obj <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20240318/SBharadwaj_20240318_Sample_1_4_7_8/data_analysis_with_cell_annotations/06_output/v0.1/Project_SBharadwaj_20240318_Sample_1_4_7_8_v0.1.rds"
# sample1 <- "ctrl_gut_CD45"
# path.to.cellchat1 <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20240318/SBharadwaj_20240318_Sample_1_4_7_8/data_analysis_with_cell_annotations/03_output/v0.1/ctrl_gut_CD45/CellChat_object.ctrl_gut_CD45.Filter10.rds"
# sample2 <- "treated_gut_CD45"
# path.to.cellchat2 <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20240318/SBharadwaj_20240318_Sample_1_4_7_8/data_analysis_with_cell_annotations/03_output/v0.1/treated_gut_CD45/CellChat_object.treated_gut_CD45.Filter10.rds"
# path.to.save.output <- "/media/hieunguyen/HD01/outdir/CRC1382/SBharadwaj_20240318/SBharadwaj_20240318_Sample_1_4_7_8/data_analysis_with_cell_annotations/03_output/v0.1/ctrl_gut_CD45_vs_treated_gut_CD45"
...
if (chosen.group == "condition"){
  print("Changing the sample name to sample condition")
...
# sample1.cells <- subset(s.obj@meta.data, s.obj@meta.data$name == sample1 & s.obj@meta.data$cell.annotation %in% shared.clusters) %>% row.names()
# sample2.cells <- subset(s.obj@meta.data, s.obj@meta.data$name == sample2 & s.obj@meta.data$cell.annotation %in% shared.clusters) %>% row.names()
